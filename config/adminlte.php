    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'route'  => 'acreditable.show',
            'icon' => 'fas fa-fw fa-book',
            'can'  => 'acreditables.show',
        ],
        [
            'text' => 'Registrar Acreditable',
            'route'  => 'acreditable.create',
            'icon' => 'fas fa-fw fa-book',
        ...
        [
            ...
            'route'  => 'professor.asignaturas.resumen',
            'icon' => 'fas fa-fw fa-book',
        ...
        [
            ...
            'route'  => 'student.asignaturas.show',
            'icon' => 'fas fa-fw fa-book',
            'can'  => 'student.asignaturas.show',
        ],
        [
        ...
        [
            'text' => 'Foro UTDeltaica',
            'url'  => 'admin/settings',
            'icon' => 'fas fa-fw fa-book',
            'can'  => 'student.asignaturas.show',
        ],
        [
            'text' => 'Acerca de SCG@ 2.0',
            'url'  => 'admin/settings',
            'icon' => 'fas fa-fw fa-book',
            'can'  => 'student.asignaturas.show',
        ],
