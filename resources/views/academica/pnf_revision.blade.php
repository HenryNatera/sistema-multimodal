                        ...
                        @if ($trim->pnf_id == $pnf->id && $trim->trayecto == 'i')
                            <tr>
                                @php
                                    $url = url('utdft/academica/horario/' . $profesor->id . '/' . $pnf->id . '/' . $regular->id);
                                @endphp
                                <td><a class="text-dark" href="{{ $url }}">{{ $trim->unidad_curricular }}:
                                        {{ $trim->trimestre_i }}</a></td>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @foreach ($trimestrals as $trim)
                        @if ($trim->pnf_id == $pnf->id && $trim->trayecto == 'i')
                            <tr>
                                <td><a class="text-dark" href="">{{ $trim->unidad_curricular }}:
                                        {{ $trim->trimestre_ii }}</a></td>
                                <td style="text-align: center;">2</td>
                                <td>{{ $trim->uc_ii }}</td>
                            </tr>
                        @endif
