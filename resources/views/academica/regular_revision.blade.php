...
@section('content_header')
    <h1 style="font-size: 20px; text-transform:capitalize;">Asignacion de horas Trayecto {{ $regular->regular_trayecto }}
    </h1>
@stop
@section('css')
        ...
        <div class="d-flex flex-wrap w-100 mb-5">
            <div class="card ml-5 w-25">
                <div class="card-header">
                    ...
                    <p style="text-transform: capitalize;"><b>Unidad Curricular:</b> {{ $regular->regular_name }}
                        {{ $regular->regular_trayecto }}</p>
                </div>
                <div class="card-body">
