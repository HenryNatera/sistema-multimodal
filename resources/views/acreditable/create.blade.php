    ...
    <main class="d-flex justify-content-center">
        <div class="card w-75">
            <div class=" bg-warning">
                <p class="h4 font-weight-light py-1 text-white text-center">Registro de Unidad Acreditable</p>
            </div>
            ...
            <div class="card-body p-0 mt-3">
                ...
                <form action="{{ route('acreditable.store') }}" method="POST">
                    ...
                    <div class="mx-3 my-4">
                        ...
                        <input name="acreditable_name" type="text"
                            class="border-top-0 border-left-0 border-right-0 border-secondary w-75"
                            style="outline: none; border-width:1px; color:#777;">
                    </div>
                    ...
                    <div class="mx-3 my-4">
                        ...
                        <input list="professors" name="acreditable_profesor"
                            class="border-top-0 border-left-0 border-right-0 border-secondary w-50"
                            style="outline: none; border-width:1px; color:#777;">
                        <datalist id="professors">
                            @foreach ($professors as $professor)
                                <option value="{{ $professor->user->name }} {{ $professor->user->last_name }}">
                                    {{ $professor->user->name }} {{ $professor->user->last_name }}</option>
                            @endforeach
                        </datalist>
