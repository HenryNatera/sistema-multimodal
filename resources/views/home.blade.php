...
@section('content')
    <main style="display: flex; flex-wrap:wrap; justify-content:space-between">
            ...
            <div class="card" style="width: 12rem">
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item" style="padding:10px 0; font-size: 14px"><a style="color:#000;"
                                href="" class="card-text">Horario de clases</a></li>
                    </ul>
                </div>
            </div>
        @endif
        ...
        <a target="_blank" href="#" class="card text-white bg-dark mb-3"
            style="max-width: 18rem; position:absolute; right:50px; bottom:20px;">
