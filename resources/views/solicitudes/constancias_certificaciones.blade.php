            ...
            <tbody>
                ...
                @if ($solicitud->user_id == Auth::user()->id)
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" href="{{route($solicitud->solicitud_view, $solicitud)}}">Imprimir</a></td>
                    </tr>
                @endif
                @endforeach
            </tbody>
        ...
        <div class="card-header">
            ...
            <ul class="list-group" style="font-size:13px;">
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Constancia de Buena conducta</button></li>
                </form>
                ...
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <input type="hidden" name="solicitud_view" value="solicitud.constancia.estudios">
                                        <input type="hidden" name="solicitud_status" value="pendiente">
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Constancia de Estudios</button></li>
                </form>
                ...
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <input type="hidden" name="solicitud_view" value="solicitud.comprobante.inscripcion">
                                        <input type="hidden" name="solicitud_status" value="pendiente">
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Comprobante de Inscripción (Horario)</button></li>
                </form>
                ...
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <input type="hidden" name="solicitud_view" value="solicitud.certificacion.calificaciones">
                                        <input type="hidden" name="solicitud_status" value="pendiente">
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Certificación de Calificaciones (Regulares)</button></li>
                </form>
                ...
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <input type="hidden" name="solicitud_view" value="solicitud.record.academico">
                                        <input type="hidden" name="solicitud_status" value="pendiente">
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Record Académico</button></li>
                </form>
                ...
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <input type="hidden" name="solicitud_view" value="solicitud.historial.academico">
                                        <input type="hidden" name="solicitud_status" value="pendiente">
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Historial Académico</button></li>
                </form>
                ...
                <form action="{{route('student.solicitud.store', $student)}}" method="POST">
                    ...
                    <input type="hidden" name="solicitud_view" value="solicitud.culminacion.carrera">
                                        <input type="hidden" name="solicitud_status" value="pendiente">
                    <li class="list-group-item py-1" style="border:none;"><button type="submit" class="list-group-item p-0 m-0" style="border:none; color:#000">Constancia de Culminación de carrera</button></li>
                </form>
