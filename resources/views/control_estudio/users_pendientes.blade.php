                ...
                <table style="font-size: 13px;" class="table" id="students">
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                <td class="py-1"><a href="{{ route('control.pnfs.show', $user) }}">{{ $user->id }}</a>
                                </td>
                                <td class="py-1"><a href="{{ route('control.pnfs.show', $user) }}">{{ $user->name }}
                                        {{ $user->last_name }}</a></td>
                                <td class="py-1"><a href="{{ route('control.pnfs.show', $user) }}">{{ $user->cedula }}</a>
                                </td>
