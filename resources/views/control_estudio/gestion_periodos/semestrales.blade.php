...
@section('content')
    ...
    <main style="display: flex; flex-wrap:wrap; justify-content:space-between">
        @if ($pe->lapso_semestral == 1)

            <div class="card w-75">
                <div class="card-header w-100 py-0 d-flex justify-content-end">
                    <p><b>Fecha de cierre: </b>{{ $pe->semestral_lapso_cierre }}</p>
                </div>
                <div class="card-header py-1">
                    <h6><b>Lapso Actual:</b> {{ $pe->semestral_lapso_inicio }}</h6>
                ...
                @if ($pe->semestral_lapso_cierre <= $fechaActual)
        ...
        @elseif($pe->lapso_semestral == 0)
            <div class="card w-75">
                <div class="card-header">
                    <h5>Nuevo Lapso semestral</h5>
                </div>
                <div class="card-body d-flex flex-wrap align-items-start justify-content-between">
                    ...
                    <div class="card w-25">
                        <form action="{{ route('control.semestral.new', $pe) }}" method="POST">
                            @method('PATCH')
                            @csrf
